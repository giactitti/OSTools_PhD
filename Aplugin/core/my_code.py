...
class MyCode:
    ...
    def add_to_image(self, constant: float) -> np.ndarray:
        ...
        """
        const_image=self.image + constant 
        return const_image
    ...
    def execute(self, constant: float, threshold: float, set_progress: callable = None,
        ...
        const_image=self.add_to_image(constant)

        print(const_image[0,0])
        ...
        #print(indices_to_set_to_zero[0])
        # step 3: set those pixels to 0
        result=np.where(const_image < threshold, -9999, const_image)
        #const_image[indices_to_set_to_zero[0],indices_to_set_to_zero[1]] = -9999
