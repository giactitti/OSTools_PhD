...
from qgisplugintest.core.my_code import MyCode
from qgisplugintest.interfaces import import_image, write_image
...
class MyWidget(QDialog):
    ...
    def _run(self):
        ...
        output_path = write_image(file_path=output_path, image=result, geo_transform=metadata['geo_transform'],
                                    projection=metadata['projection'], n_bands=metadata['n_bands'])
